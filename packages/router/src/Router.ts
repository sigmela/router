...
export class Router {
  ...
  constructor(config: RouterConfig) {
    ...
    if (this.tabBar) {
      this.state = { history: [], activeTabIndex: this.tabBar.getState().index };
    }
    ...
    if (this.global) {
      ...
      if (gtop) {
        ...
        this.visibleRoute = meta
          ? { ...meta, routeId: gtop.routeId, params: gtop.params, query: gtop.query }
          : {
      ...
      if (route) {
        ...
        if (stack) {
          ...
          if (top) {
            ...
            this.visibleRoute = meta
              ? { ...meta, routeId: top.routeId, params: top.params, query: top.query }
              : {
                  routeId: top.routeId,
                  stackId: sid,
                  tabIndex: idx,
  ...
  private parsePath(path: string): { pathname: string; query: Record<string, unknown> } {
